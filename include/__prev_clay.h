// EDITED BY ME (for raylib types for colour, etc)
...
typedef Vector2 Clay_Vector2; // use raylib Vector2

// Internally clay conventionally represents colors as 0-255, but interpretation is up to the renderer.
typedef Color Clay_Color; // use raylib Color (not float-based, like is expected by clay, technically)

typedef Rectangle Clay_BoundingBox; // use raylib Rectangle
